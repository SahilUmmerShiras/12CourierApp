...
public class topratedfilms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_topratedfilms);
        ...
        resultsCall.enqueue(new Callback<Feed>() {
            ...
            public void onResponse(Call<Feed> call, Response<Feed> response) {
                ...
                if(movies!=null)
                {customadapter = new customadapter(topratedfilms.this,movies);
                    recyclerView.setLayoutManager(new LinearLayoutManager(topratedfilms.this));
