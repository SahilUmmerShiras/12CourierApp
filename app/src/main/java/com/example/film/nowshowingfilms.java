...
public class nowshowingfilms extends AppCompatActivity {
public RecyclerView recyclerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nowshowingfilms);
        ...
        resultsCall.enqueue(new Callback<Feed>() {
            ...
            public void onResponse(Call<Feed> call, Response<Feed> response) {
                ...
                if(movies!=null)
                {customadapter = new customadapter(nowshowingfilms.this,movies);
                    recyclerView.setLayoutManager(new LinearLayoutManager(nowshowingfilms.this));
