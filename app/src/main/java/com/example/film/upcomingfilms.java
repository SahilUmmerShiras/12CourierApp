...
public class upcomingfilms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upcomingfilms);
        ...
        resultsCall.enqueue(new Callback<Feed>() {
            ...
            public void onResponse(Call<Feed> call, Response<Feed> response) {
                ...
                if(movies!=null)
                {customadapter = new customadapter(upcomingfilms.this,movies);
                    recyclerView.setLayoutManager(new LinearLayoutManager(upcomingfilms.this));
